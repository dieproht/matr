    ...
    it should "apply given function element-wise on the given Matrices" in {
      ...
      forAll { (mLhs: Matrix[3, 2, Int], mRhs: Matrix[3, 2, Int]) => 
        ...
        val mExp: Matrix[3, 2, Int] = 
          MatrixFactory[3, 2, Int].rowMajor(fn(mLhs(0, 0), mRhs(0, 0)), fn(mLhs(0, 1), mRhs(0, 1)), 
                                            fn(mLhs(1, 0), mRhs(1, 0)), fn(mLhs(1, 1), mRhs(1, 1)), 
                                            fn(mLhs(2, 0), mRhs(2, 0)), fn(mLhs(2, 1), mRhs(2, 1))
                                           )
