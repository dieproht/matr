  ...
  class MatrixMkStringSpec extends MatrFlatSpec:
    ...
    "Matrix.mkString" should "correctly render 3x2 Int Matrix" in {
      ...
      val m: Matrix[3, 2, Int] = 
        MatrixFactory[3, 2, Int].rowMajor(3,    489, 
                                          2234, 1, 
                                          49,   4)
    ...
    it should "correctly render 2x2 Int Matrix" in {
      ...
      val m: Matrix[2, 2, Int] = 
        MatrixFactory[2, 2, Int].rowMajor(3,  489, 
                                          49, 4)
    ...
    it should "correctly render 2x1 Int Matrix" in {
      ...
      val m: Matrix[2, 1, Int] = 
        MatrixFactory[2, 1, Int].rowMajor(3,
                                          49)
    ...
    it should "correctly render 4x1 Int Matrix" in {
      ...
      val m: Matrix[4, 1, Int] = 
        MatrixFactory[4, 1, Int].rowMajor(3,  
                                          1789, 
                                          0, 
                                          49)
    ...
    it should "correctly render 4x5 Double Matrix" in {
      ...
      val m: Matrix[4, 5, Double] = 
        MatrixFactory[4, 5, Double].rowMajor(3.14,     489.9,    0.0,    78.34, 90.3,
    ...
    "Matrix.mkString with custom element renderer" should "correctly render 2x3 Double Matrix" in {
      ...
      val m: Matrix[2, 3, Double] = 
        MatrixFactory[2, 3, Double].rowMajor(3.14,     489.9, 0.0, 
                                             2234.423, 1.0,   27.543)
