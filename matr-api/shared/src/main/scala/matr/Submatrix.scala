package matr:
  ...
  /** Type class for getting the submatrix of a Matrix. 
    * 
    * @tparam RowIdxTL Row index of the element that should become the top-left element of the submatrix
    * @tparam ColIdxTL Column index of the element that should become the top-left element of the submatrix
    * @tparam RowIdxBR Row index of the element that should become the bottom-right element of the submatrix
    * @tparam ColIdxBR Column index of the element that should become the bottom-right element of the submatrix
    * @tparam R Row dimension of the original Matrix
    * @tparam C Column dimension of the original Matrix
