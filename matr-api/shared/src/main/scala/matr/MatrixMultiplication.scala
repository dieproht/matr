...
/** Type class for the multiplication (calculating the dot product) of Matrices. The result's
  * element type will be calculated at compile-time, based on the element type of the operands.
  *
  * @tparam R
  *   Row dimension of the left-hand side operand
  * @tparam C
  *   Column dimension of the left-hand side operand and row dimension of the right-hand side
  *   operand
  * @tparam L
