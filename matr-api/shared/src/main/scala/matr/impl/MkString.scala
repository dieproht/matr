package matr.impl:
  ...
  private[matr] object MkString:
    ...
    inline private def preprocessMatrix[R <: Int, C <: Int, T](m: Matrix[R, C, T], elemToString: T => String): (Array[Int], Array[Array[String]]) =
    ...
    inline private def renderMatrix(rowDim: Int, colDim: Int, colWidths: Array[Int], rowMajorStrings: Array[Array[String]]): String = 
    ...
    inline private def renderSingleRowMatrix(builder: StringBuilder, colDim: Int, rowMajorStrings: Array[Array[String]]): Unit = 
      builder += '('
      var colIdx: Int = 0
    ...
    inline private def renderMultiRowMatrix(builder: StringBuilder, rowDim: Int, colDim: Int, colWidths: Array[Int], rowMajorStrings: Array[Array[String]]): Unit = 
