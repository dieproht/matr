...
case class DefaultSparseMatrix[R <: Int, C <: Int, T](private val elements: Map[
  (Int, Int),
  T
])(using num: Numeric[T])(using Matrix.Requirements.NonNegativeDimensions[R, C])(using vr: ValueOf[R], vc: ValueOf[C])
